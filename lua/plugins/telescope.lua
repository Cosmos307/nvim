-- Fuzzy Finder: Telescope with performance optimizations
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Classic g-prefixed LSP jumps (overrides Vim's gd/gD in LSP buffers; see :help gd)
          -- Find references for the word under your cursor.
          vim.keymap.set('n', 'gr', builtin.lsp_references, { buffer = buf, desc = '[G]oto [R]eferences' })

          -- Jump to the implementation of the word under your cursor.
          -- Overrides Vim's default gi (last insert) in LSP buffers only; see :help gi
