-- Make terminal background show through (required for Ghostty opacity to work)
vim.api.nvim_create_autocmd('ColorScheme', {
  pattern = '*',
  callback = function()
    vim.api.nvim_set_hl(0, 'Normal', { bg = 'none' }) -- Main window background
    ...
    vim.api.nvim_set_hl(0, 'SignColumn', { bg = 'none' }) -- Gutter/sign column background
  end,
})
